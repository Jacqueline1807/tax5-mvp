...
const translations: Record<Language, Record<string, Record<string, string>>> = {
  EN: {
    ...
    demoAccess: {
      ...
      subtitleWelcome: "Sign up or log in to store actual receipts on our secure sandbox, or access offline demo profile.",
      ...
      dontNeedAcc: "Don't need an account? Test the complete Tax5 interactive sandbox securely without registering:",
      tryDemoBtn: "Launch Interactive Demo Mode",
      loginTitle: "Log In to Sandbox",
      signupTitle: "Create Sandbox Account",
      loginToggle: "Already have an account? Sign In",
      signupToggle: "Need a new account? Sign Up",
  ...
  BM: {
    ...
    demoAccess: {
      ...
      subtitleWelcome: "Daftar atau log masuk untuk menyimpan resit sebenar dalam kotak pasir selamat kami, atau akses profil demo luar talian.",
      emailLabel: "Alamat E-mel",
      emailPlace: "cth. nama@domain.com",
      passLabel: "Kata Laluan Selamat",
      ...
      dontNeedAcc: "Tidak memerlukan akaun? Log masuk ke mod demo sandboks interaktif Tax5 secara selamat tanpa mendaftar:",
      tryDemoBtn: "Lancar Mod Demo Interaktif",
      loginTitle: "Log Masuk ke Kotak Pasir",
      signupTitle: "Daftar Akaun Kotak Pasir",
      loginToggle: "Sudah mempunyai akaun? Log Masuk",
      signupToggle: "Perlukan akaun baru? Daftar Akaun",
